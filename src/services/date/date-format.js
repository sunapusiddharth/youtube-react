...
export function getVideoDurationString(iso860DateString){
    if(!iso860DateString || iso860DateString === ''){
        return ''
    }

    let {days,hours,minutes,seconds} = parseISO8601TimePattern(iso860DateString)
